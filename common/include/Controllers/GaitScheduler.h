...
#include "../../robot/include/KIST_UserParameters.h"
...
class GaitScheduler {
 public:
  ...
  GaitScheduler(KIST_UserParameters* _userParameters, float _dt);
  ~GaitScheduler(){};
...
// #include "kist_legged_robot/KIST_UserParameters.h"
...
//   // Gait descriptors
//   float periodTimeNominal;      // overall period time to scale
//   float initialPhase;           // initial phase to offset
//   float switchingPhaseNominal;  // nominal phase to switch contacts
//   int overrideable;
...
//   // Time based descriptors
//   Vector4d periodTime;           // overall foot scaled gait period time
//   Vector4d timeStance;           // total stance time
//   Vector4d timeSwing;            // total swing time
//   Vector4d timeStanceRemaining;  // stance time remaining
//   Vector4d timeSwingRemaining;   // swing time remaining

//   // Phase based descriptors
//   Vector4d switchingPhase;  // phase to switch to swing
//   Vector4d phaseVariable;   // overall gait phase for each foot
//   Vector4d phaseOffset;     // nominal gait phase offsets
//   Vector4d phaseScale;      // phase scale relative to variable
//   Vector4d phaseStance;     // stance subphase
//   Vector4d phaseSwing;      // swing subphase
