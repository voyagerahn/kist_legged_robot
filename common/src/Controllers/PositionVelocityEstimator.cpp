...
//   float dt = this->_stateEstimatorData.parameters->controller_dt;
//   _xhat.setZero();
//   _ps.setZero();
//   _vs.setZero();
//   _A.setZero();
...
//   _C.block(6, 0, 3, 6) = C1;
//   _C.block(9, 0, 3, 6) = C1;
//   _C.block(0, 6, 12, 12) = -1 * Eigen::Matrix<float, 12, 12>::Identity();
//   _C.block(12, 0, 3, 6) = C2;
//   _C.block(15, 0, 3, 6) = C2;
//   _C.block(18, 0, 3, 6) = C2;
//   _C.block(21, 0, 3, 6) = C2;
...
//   Vector3d g(0, 0, -9.81);
//   Matrix3d Rbod = this->_stateEstimatorData.result->rBody.transpose();
//   // in old code, Rbod * se_acc + g
//   Vector3d a = this->_stateEstimatorData.result->aWorld + g;
//   // std::cout << "A WORLD\n" << a << "\n";
...
//     // hw_i->leg_controller->leg_datas[i].v;
//     Vector3f dp_rel = this->_stateEstimatorData.legControllerData[i].v;
//     Vector3f p_f = Rbod * p_rel;
//     Vector3f dp_f =
//         Rbod *
//         (this->_stateEstimatorData.result->omegaBody.cross(p_rel) + dp_rel);
...
//     double trust = 1;
//     double phase =
//         fmin(this->_stateEstimatorData.result->contactEstimate(i), T(1));
//     // T trust_window = T(0.25);
